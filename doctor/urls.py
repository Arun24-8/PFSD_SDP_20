...
urlpatterns = [
    ...
    path('appointments/<int:appointment_index>/prescription/', views.doctor_appointment_prescription,
         name='doctor_appointment_prescription'),
    ...
    path('patients/export/', views.doctor_export_patients,
         name='doctor_export_patients'),
